...
const Footer = () => {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    With Evently drag-and-drop tools, event organizers can easily create and manage Emailers, Event Websites, RSVP forms, Registrations, Event apps, Onsite Checkin, and more - without any skills in DESIGN or CODING.
    </p>
